...
import { FOUNDER_WHATSAPP } from '../lib/data';
  ...
  return (
    <div className="fixed bottom-6 right-6 z-40 flex flex-col gap-3">
      ...
      <a
        ...
        className="flex h-14 w-14 items-center justify-center rounded-full bg-forest-600 text-white shadow-lift transition hover:scale-110"
      >
